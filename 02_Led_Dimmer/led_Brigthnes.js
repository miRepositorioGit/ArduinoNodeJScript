/** led_Brigthness.js    recibe, envia un dato vía puerto serie, regula un magnitud analógica.
  ...
  *   controla la intensidad de brillo en un led, conectado en una salida analógica de un microcontrolador.
  *
  *       |=#========|											
  *      min		    max	  
 ...
 */
app.get('/', function (req, res) { res.sendFile(__dirname + '/public/interface.html'); });
...
/** recibe dato del puerto serial */
parser.on('data', function (data) { console.log("\t receiving from serial: " + parseInt(data, 10)); });
